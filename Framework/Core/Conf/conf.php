...
return array(
	...
	'VIEW_CONFIG' => array(
		...
		'SMARTY_TEMPLATE_DIR' => APP_PATH . DS . 'View/',			// 模板目录，请不要随意修改
		'SMARTY_COMPILE_DIR' => APP_PATH . DS . 'Temp/Compiled',	// 编译模板目录，请不要随意修改
		'SMARTY_CACHE_DIR' => APP_PATH . DS . 'Temp/Cache',			// 静态网页缓存目录，请不要随意修改
		...
		'TMPLITE_TEMPLATE_DIR' => APP_PATH . DS . 'View/',			// 模板目录，请不要随意修改
		'TMPLITE_COMPILE_DIR' => APP_PATH . DS . 'Temp/Compiled',	// 编译模板目录，请不要随意修改
		'TMPLITE_CACHE_DIR' => APP_PATH . DS . 'Temp/Cache/',		// 静态网页缓存目录，请不要随意修改
