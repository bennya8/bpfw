...
class Base
{
	...
	private static $_coreClasses = array(
		...
		'Database' => '/Core/DB/Database.class.php',
		'Database_Dao' => '/Core/DB/Database_Dao.class.php',
		'Database_MySQL' => '/Core/DB/Database_MySQL.class.php',
		'Database_MySQLi' => '/Core/DB/Database_MySQLi.class.php',
		'Database_PDO' => '/Core/DB/Database_PDO.class.php',
